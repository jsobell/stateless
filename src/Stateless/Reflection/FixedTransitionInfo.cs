...
namespace Stateless.Reflection
{
    ...
    {
        internal static FixedTransitionInfo Create<TState, TTrigger, TTag>(StateMachine<TState, TTrigger, TTag>.TriggerBehaviour behaviour, StateInfo destinationStateInfo)
        {
